  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "slide-up-3d": "slide-up-3d 0.7s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
        "flip-in": "flip-in 0.8s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
        "rotate-3d": "rotate-3d 20s linear infinite",
        "bounce-3d": "bounce-3d 2s ease-in-out infinite",
        "tilt-in": "tilt-in 0.8s cubic-bezier(0.25, 0.46, 0.45, 0.94)",
